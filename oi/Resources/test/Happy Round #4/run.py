...
def diff(file1, file2):
    ...
    # if len(L1) != len(L2):
    #     return (False, 0, 'Incorrect length', 'Incorrect length')
...
for i in range(startid, endid + 1):
    ...
    print("Used time: {}s".format(passed))

    if flag:        
        print('\033[35mTime Limit Exceeded\033[0m')

    if flag:
        if status != 0:
            print('\033[33mRuntime Error\033[0m')
