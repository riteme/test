...
int main() {
    ...
    auto initduration = chrono::duration_cast<chrono::milliseconds>(
                            initend - initstart).count();
    printf("Start time: %lld milliseconds.\n", initduration);
    ...
    for (int i = 1; i <= m; i++) {
        ...
        auto timespan = chrono::duration_cast<chrono::milliseconds>(
                            endtime - starttime).count();
        printf("Testcase #%d: %lld milliseconds.\n", i, timespan);
    }
